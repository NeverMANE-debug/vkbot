...
async def reassign(m: Message):
    try:
        cursor.execute(f"update PHIL values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update PL values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update FL values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update PaS values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update MLaAT values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update BIS values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update RL values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update PHYS values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update MA values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update ECO values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
        cursor.execute(f"update PRAC values('{m.from_id}', '&#10060;', '&#10060;')")
        conn.commit()
